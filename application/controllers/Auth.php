...
class auth extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('username', 'Username', 'required|trim|min_length[6]', array('min_length' => 'Karakter {field} terlalu pendek !', 'required' => '{field} wajib diisi !'));
        $this->form_validation->set_rules('password', 'Password', 'required|trim|min_length[6]', array('min_length' => 'Karakter {field} terlalu pendek !', 'required' => '{field} wajib diisi !'));
